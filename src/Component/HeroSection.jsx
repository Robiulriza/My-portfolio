    ...
    return (
        <section className='relative w-full' data-aos='zoom-in-up'>
            ...
            <div className='w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-5xl lg:max-w-7xl mx-auto relative'>
                <div className='grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:w-3xl mx-auto'>
                    <div className='lg:py-6'>
                        ...
                        <p className='text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl'>Junior Frontend Developer proficient in building responsive, user-centric web applications using JavaScript (ES6+) and Bootstrap, Tailwind CSS. Experienced in translating Figma designs into clean, maintainable code and optimizing asset loading to improve performance. Eager to bring strong debugging skills and version control workflow (Git) to a collaborative development team.</p>
                        <div className='flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max lg:mx-0'>
                            ...
                            <a href={resumeUrl} target="_blank" rel="noopener noreferrer" className='border border-cyan-400 px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex items-center justify-center gap-2 text-primary hover:bg-white/10 transition-all ease-in-out'>
                                <Download size={18} />
                                <span className='font-medium hover:scale-105 origin-center transition-all ease-in-out'>Download resume</span>
                            </a>
                        </div>
                    ...
                    <div className='lg:h-full md:flex'>
                        <div className='flex w-full h-96 min-h-96 lg:min-h-{none} lg:w-full items-center relative'>
                            ...
                            -translate-y-1/2 lg:right-3 md:right-40 sm:right-16 w-5/6 right-0 h-[calc(80%+20px)] bg-linear-to-r opacity-25 from-[#0c64ac] to-primary blur-2xl '>
