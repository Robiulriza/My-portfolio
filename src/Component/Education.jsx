    ...
    const educationData = [
        {
            ...
            institution: "Savar Laboratory School and College",
            duration: "2023",
            details: 'Completed',
        },
        {
                ...
                <div className='flex flex-col lg:flex-row items-center gap-16 '>
                    <div className='w-full lg:w-5/12 flex justify-center lg:justify-start' data-aos='fade-right'>
                        <div className='relative'>
                            <div className='absolute h-full w-full z-0 translate-x-4 translate-y-4 rounded-2xl shadow-lg border border-cyan-500'></div>
                            <div className='relative z-10 bg-[#111a3e] rounded-2xl overflow-hidden border border-[#1f1641]'>
                                <img src={Educ} alt="" className='w-64 h-64 md:w-96 md:h-120 object-cover transform transition-transform duration-500 hover:scale-110' />
                    ...
                    <div className='w-full lg:w-7/12 space-y-6' data-aos='fade-left'>
                        {educationData.map((edu) => (
                            ...
                            >
                                ...
                                <div className='flex items-center gap-2 text-xs uppercase tracking-wide text-primary font-bold'>
                                    <CheckCircle size={12} />
                                    Academic Excellence
                                </div>
                            </div>
